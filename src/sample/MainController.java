...
public class MainController implements Initializable {
    ...
    private String DEFAULTTIMETODEADLINE = " 0 days  |   00 : 00: 00 ";
    ...
    @FXML
    private Label labelTime;        // clock of Default Time Zone ( for digital clock;)
    @FXML
    ...
    @FXML
    private VBox layoutClock; // for analogue clock;
    /*
    ...
    private ArrayList<Label> labelСlocks = new ArrayList<>(); // Array of label for name of selected time zone;
    private ArrayList<String> deleteItems = new ArrayList<>(); // items for combobox for deleting;
    private ArrayList<String> labelsName = new ArrayList<>(); // for name of selected Time Zone;
    ...
    public void getDeadlineInfo(Date date) {
        try {
            ...
            if (localDate.isBefore( LocalDate.now() )) {
                labelTimeToDeadline.setText(DEFAULTTIMETODEADLINE );
            } else {
                    deadlineDate =  date ;
                    saveToXML();
                    isDeadline = true;
...
/*
Thread for update time to deadline and digital clock;
 */
