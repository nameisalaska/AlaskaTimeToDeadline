...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["About","About","To work with program","About Developer","Select needed time zone","Set \"Deadline\"","Background work"],
    DREX_NODE_LINKS: ["index.htm","about.htm","to_work_with_program.htm","about_developer.htm","select_needed_time_zone.htm","set__deadline_.htm","background_work.htm"],
    DREX_NODE_CHILD_START: [1,4,4,7,7,7,7],
    DREX_NODE_CHILD_END: [4,4,7,7,7,7,7],
    DREX_MENU_TYPE: 1,
